...
# ubuntu-iso-builder-respin-spectrwm
...
| `+` | `+` |
| [ubuntu-iso-builder-remix-spectrwm](https://samwhelp.github.io/ubuntu-iso-builder-remix-spectrwm/) | [GitHub](https://github.com/samwhelp/ubuntu-iso-builder-remix-spectrwm) |
| `=` | `=` |
| [ubuntu-iso-builder-respin-spectrwm](https://samwhelp.github.io/ubuntu-iso-builder-respin-spectrwm/) | [GitHub](https://github.com/samwhelp/ubuntu-iso-builder-respin-spectrwm) |
...
| Config |
| ------ |
| [~/.config](https://github.com/samwhelp/ubuntu-iso-builder-respin-spectrwm/tree/main/template/asset/overlay/etc/skel/.config) |
| [/usr/share/glib-2.0/schemas](https://github.com/samwhelp/ubuntu-iso-builder-respin-spectrwm/tree/main/template/asset/overlay/usr/share/glib-2.0/schemas) |
| [/etc/dconf/db/distro.d](https://github.com/samwhelp/ubuntu-iso-builder-respin-spectrwm/tree/main/template/asset/overlay/etc/dconf/db/distro.d) |
...
> clone [ubuntu-iso-builder-respin-spectrwm](https://github.com/samwhelp/ubuntu-iso-builder-respin-spectrwm)

``` sh
git clone https://github.com/samwhelp/ubuntu-iso-builder-respin-spectrwm.git
```


> change dir to `ubuntu-iso-builder-respin-spectrwm`

``` sh
cd ubuntu-iso-builder-respin-spectrwm
```
...
> The resulting ISO file will be placed on `ubuntu-iso-builder-remix-spectrwm/dist`
